...
const FingerprintPattern = createLucideIcon("fingerprint-pattern", __iconNode$p);
const __iconNode$o = [
...
const HardDrive = createLucideIcon("hard-drive", __iconNode$o);
const __iconNode$n = [
  [
    "path",
    {
...
const ServerCog = createLucideIcon("server-cog", __iconNode$c);
const __iconNode$b = [
  [
    "path",
    {
